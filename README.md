...
Documentación
Documentación del gRPC Server
Documentación del gRPC Client
Documentación del GraphQL Server
...
gRPC Server (Servidor principal con acceso a la base de datos): http://localhost:9090

gRPC Client (Gateway encargado de exponer los métodos gRPC del servidor principal): http://localhost:8080
...
MySQL: Puerto 3306. Usuario/clave los definidos en .env.

GraphQL Server: http://localhost:8080

Mailhog (servidor): http://localhost:1025

Mailhog (UI web): http://localhost:8025

Kafbat UI (UI web de Kafka): http://localhost:8999

Rest Server (Swagger): http://localhost:9093
